...
public class AddPro extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException{
		...
		while(it.hasNext())
		{
			...
			if(test.equals("faculty_no"))
				o[3] = request.getParameter(test);
		}
		Object [] o2 = new Object[1];
		o2[0] = o[0];
		String sql = "select people_num from Professional where no=?";
		o[1] = pro.executeQuerySingle(sql,o2);
		if(o[1]==null)
			o[1] = 0;
		else
			o[1] = (int)o[1];
		int result = pro.add(o);
		if(result==0) 
