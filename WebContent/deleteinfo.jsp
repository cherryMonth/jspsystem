...
<div class="container">
<form action="/system/delinfo" method="post">
<div style="text-align:center">
<input type="radio" name="type" value="fau" >删除学院
<input type="radio" name="type" value="pro" >删除专业
<input type="radio" name="type" value="cou" >删除课程
<input type="radio" name="type" value="tea" >删除教师
<input type="radio" name="type" value="cla" >删除班级
<input type="radio" name="type" value="stu" >删除学生
</div>
<div class="col-sm-10">
